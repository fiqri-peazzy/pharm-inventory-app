            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        @if (session('status'))
                            <div class="mb-5 rounded-lg bg-green-50 p-4 dark:bg-green-900/20">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Username atau Email<span class="text-error-500">*</span>
                                        </label>
                                        <input type="text" id="login" name="login" value="{{ old('login') }}"
                                            placeholder="admin atau admin@rsud.go.id" required autofocus
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <span id="toggle-password"
                                                ...
                                                <svg id="eye-icon" class="fill-current" width="20" height="20"
                                                ...
                                                <svg id="eye-slash-icon" class="fill-current hidden" width="20" height="20"
                                                    viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="/images/logo/logo-dark.svg" alt="Logo" width="150" height="40" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Medivault - Sistem Farmasi & BMHP RSUD Bumi Panua
                        </p>
                    </div>
                </div>
            </div>
