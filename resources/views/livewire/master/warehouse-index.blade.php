                ...
                <form wire:submit.prevent="store" class="space-y-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="flex items-center gap-2">
                            <input type="checkbox" wire:model="is_main" id="is_main" class="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500">
                            <label for="is_main" class="text-sm text-gray-700 dark:text-gray-300">Set sebagai Gudang Utama</label>
                        </div>
                        <div class="flex items-center gap-2">
                            <input type="checkbox" wire:model="is_active" id="is_active_wh" class="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500">
