            ...
            <div class="relative w-full max-w-lg rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900">
                ...
                <form wire:submit.prevent="store" class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="code" class="w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm outline-none dark:bg-transparent
                            @error('code') border-red-500 focus:border-red-500 dark:border-red-500 @else border-gray-200 focus:border-brand-500 dark:border-gray-800 @enderror" placeholder="Misal: STRIP, BOX, TAB">
                        @error('code')
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="name" class="w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm outline-none dark:bg-transparent
                            @error('name') border-red-500 focus:border-red-500 dark:border-red-500 @else border-gray-200 focus:border-brand-500 dark:border-gray-800 @enderror" placeholder="Misal: Strip, Box, Tablet">
                        @error('name')
                            <p class="mt-1.5 flex items-center gap-1.5 text-xs text-red-600 dark:text-red-400">
                                <svg class="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l6.516 11.598c.75 1.334-.213 2.98-1.742 2.98H3.483c-1.53 0-2.493-1.646-1.743-2.98L8.257 3.1zM11 14a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V7a1 1 0 00-1-1z" clip-rule="evenodd" /></svg>
                                {{ $message }}
