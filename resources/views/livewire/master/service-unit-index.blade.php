            ...
            <div class="relative w-full max-w-xl rounded-2xl bg-white p-8 shadow-2xl dark:bg-gray-800 border border-white/20">
                <div class="mb-6 flex items-center justify-between border-b border-gray-100 dark:border-gray-700 pb-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Konfigurasi entitas pelayanan poliklinik atau ruangan.</p>
                    </div>
                    <button @click="open = false" class="text-gray-400 hover:text-gray-500 p-2 rounded-full hover:bg-gray-100 transition-colors">
                ...
                <form wire:submit.prevent="store" class="space-y-5">
                    <div class="grid grid-cols-2 gap-5">
                        <div>
                            <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Kode Unit</label>
                        ...
                        <div>
                            <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Tipe</label>
                    ...
                    <div>
                        <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Nama Unit Layanan</label>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div>
                            <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Kategori (Opsional)</label>
                        ...
                        <div>
                            <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Depo Pelayan</label>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div>
                            <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Gedung</label>
                        ...
                        <div>
                            <label class="mb-1.5 block text-xs font-black tracking-widest uppercase text-gray-500">Lantai</label>
                    ...
                    <div class="flex items-center gap-2 pt-2">
                        <input type="checkbox" wire:model="is_active" id="is_active_su" class="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500">
                    ...
                    <div class="mt-8 flex gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                        <button type="button" @click="open = false" class="w-1/3 rounded-lg border border-gray-200 bg-white py-3 text-sm font-bold text-gray-500 hover:bg-gray-50 transition-all uppercase tracking-widest">Batal</button>
