        ...
        <div class="flex items-center justify-center min-h-screen p-4 text-center sm:p-0">
            <div x-show="open"
                ...
                <div class="p-6 space-y-4">
                    <!-- Search Input -->
                    <div class="relative">
                        <input type="text" wire:model.live.debounce.300ms="itemSearch" class="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 font-bold text-slate-700 shadow-inner" placeholder="Cari nama barang atau kode...">
                    ...
                    <div class="max-h-[400px] overflow-y-auto rounded-xl border border-slate-100 divide-y divide-slate-100 bg-white shadow-sm">
                        ...
                        <div wire:loading wire:target="itemSearch" class="p-16 text-center">
                            ...
                            <p class="text-[10px] text-slate-400 mt-4 uppercase font-black tracking-widest italic">Mencari Data...</p>
                        </div>
                            ...
                            @forelse($searchResults as $item)
                                <button wire:click="addItem({{ $item->id }})" class="w-full flex items-center justify-between p-4 hover:bg-slate-50 transition-all text-left group">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center font-black text-lg border border-emerald-100 shadow-sm shadow-emerald-50">
                                            {{ substr($item->name, 0, 1) }}
                                        </div>
                                        <div>
                                            <div class="font-bold text-slate-800 group-hover:text-emerald-700 text-base leading-tight">{{ $item->name }}</div>
                                    ...
                                    <div class="text-[10px] font-black text-emerald-600 bg-white border border-emerald-200 px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all uppercase tracking-widest shadow-sm hover:bg-emerald-600 hover:text-white hover:border-emerald-600">
                                        TAMBAHKAN
                                    </div>
                                </button>
                            @empty
                                <div class="p-16 text-center text-slate-300">
                                    ...
                                    @else
                                        ...
                                        <p class="text-[10px] font-black uppercase tracking-widest">Ketik minimal 2 karakter...</p>
                                    @endif
                                </div>
                            @endforelse
                        </div>
                ...
                <!-- Footer -->
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 text-[9px] text-slate-400 font-bold uppercase tracking-widest italic">
