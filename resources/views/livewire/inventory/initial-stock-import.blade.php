                            ...
                            <form wire:submit.prevent="import" class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <label for="file-upload"
                                        ...
                                        @error('file') border-red-500 bg-red-50 dark:bg-red-900/20 dark:border-red-500 @else {{ $file ? 'border-green-400 bg-green-50 dark:bg-green-900/20' : 'border-gray-300 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600' }} @enderror">
