...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $modules = [
            ...
            'returns' => ['view', 'view-all', 'create', 'update', 'submit', 'approve', 'reject', 'track-credit', 'export', 'delete'],
    ...
    private function assignPermissionsToRoles(): void
    {
        ...
        $kepalaFarmasi->syncPermissions([
            ...
            'stock-adjustments.view-all', 'stock-adjustments.approve',
            'returns.view-all', 'returns.approve',
